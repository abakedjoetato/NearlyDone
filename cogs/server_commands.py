...
class ServerCommands(commands.Cog):
    ...
    @server_group.command(
        name="list", 
        description="List all servers configured for this Discord server",
    ...
    async def list_servers(self, ctx):
        ...
        try:
            ...
            embed.set_footer(text="Use /server info <name> for details")
    ...
    @server_group.command(
        name="credentials",
        description="Set SFTP credentials for remote log access",
        contexts=[discord.InteractionContextType.guild], 
        integration_types=[discord.IntegrationType.guild_install]
    )
    @commands.has_permissions(manage_guild=True)
    ...
    @server_group.command(
        name="status",
        description="Check status of all configured servers",
        contexts=[discord.InteractionContextType.guild], 
        integration_types=[discord.IntegrationType.guild_install]
    )
